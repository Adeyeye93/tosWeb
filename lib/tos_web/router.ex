defmodule TosWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {TosWeb.Layouts, :root}
  ...
  scope "/", TosWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TosWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TosWeb do
    ...
    live_session :current_user,
      on_mount: [{TosWeb.UserAuth, :mount_current_user}] do
